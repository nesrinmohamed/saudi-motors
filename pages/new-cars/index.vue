...
const searchBtn = () => {
  ...
  page.value = 1;
  setFilter();
  // return infoStore.setFactoryId(filters.factoryId);
};

/*##########[ LIFE CYCLE ]##########*/

useAsyncData(() => {
  axios.get(`/advertisements?is_new=1`).then((response) => {
  ...
  <div class="new-cars-page">
    ...
    <v-row class="mt-10">
      <v-col cols="12" md="9">
        ...
        <StaticSectionsNewCars></StaticSectionsNewCars>
      </v-col>
      <!-- ========LEFT SIDEBAR==== -->
      <v-col md="3">
