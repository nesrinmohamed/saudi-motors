...
const setFilterAll = async () => {
  await axios.get(`/advertisements?is_new=1`).then((response) => {
...
const filterdByNewest = async () => {
  await axios.get(`/advertisements?is_new=1&newest=`).then((response) => {
    infoStore.advertisements.data = response.data.data.data;
  });
};

const filterdByOldest = async () => {
  await axios.get(`/advertisements?is_new=1&oldest=`).then((response) => {
    infoStore.advertisements.data = response.data.data.data;
  });
};
const filterdByLowerPrice = async () => {
  await axios.get(`/advertisements?is_new=1&lower_price=`).then((response) => {
    infoStore.advertisements.data = response.data.data.data;
  });
};

const filterdByHigherPrice = async () => {
  await axios.get(`/advertisements?is_new=1&higher_price=`).then((response) => {
    infoStore.advertisements.data = response.data.data.data;
  });
};
...
const setFilter = async () => {
  await axios
    .get(`/advertisements?is_new=1&oldest=&newest=&lower_price=&higher_price=`)
    .then((response) => {
