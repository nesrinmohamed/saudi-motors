...
const filterdByNewest = async () => {
  await axios.get(`/advertisements?newest=`).then((response) => {
    infoStore.advertisements.data = response.data.data.data;
  });
};

const filterdByOldest = async () => {
  await axios.get(`/advertisements?oldest=`).then((response) => {
    infoStore.advertisements.data = response.data.data.data;
  });
};
const filterdByLowerPrice = async () => {
  await axios.get(`/advertisements?lower_price=`).then((response) => {
    infoStore.advertisements.data = response.data.data.data;
  });
};

const filterdByHigherPrice = async () => {
  await axios.get(`/advertisements?higher_price=`).then((response) => {
    infoStore.advertisements.data = response.data.data.data;
  });
};
...
const setFilter = async () => {
  await axios
    .get(`/advertisements?oldest=&newest=&lower_price=&higher_price=`)
    .then((response) => {
